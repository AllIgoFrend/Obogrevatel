...
#define SSD1306_H 100
    ...
    #define CMD_REGISTR                         0x00
    #define DATA_REGISTR                        0x40
    //SSD1306
    /* SSD1306 I2C address */
    /**
...
#define SSD1306_I2C_ADDR_3    (0x78)
#define SSD1306_I2C_ADDR_4    (0x7A)
 ...
 * @param length dlinna polya v kotorom pishutsya bykvi
 * @param c The character to draw
 * @param foreground Character color
 * @param background Background color
 * @return Width of the character or negative value if error occurred
 */
int ssd1306_draw_char(const ssd1306_t *dev, uint8_t *fb, const font_info_t *font, uint8_t x, uint8_t y, uint8_t length, char c, ssd1306_color_t foreground, ssd1306_color_t background);
 ...
 */
int ssd1306_draw_string(const ssd1306_t *dev, uint8_t *fb, const font_info_t *font, uint8_t x, uint8_t y, uint8_t length, const char *str, ssd1306_color_t foreground, ssd1306_color_t background);
